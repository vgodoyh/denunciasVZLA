<x-layouts::admin :title="'Tipos de Emisor'">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tipos de Emisor</h5>
            <div>
                <a href="{{ route('tipo_emisor.papelera') }}" class="btn btn-outline-dark me-2">
                    <i class="fas fa-trash"></i> Papelera
                </a>
                <a href="{{ route('tipo_emisor.create') }}" class="btn btn-dark">
                    <i class="fa-solid fa-plus-circle"></i> Crear tipo de emisor
                </a>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-items-center mb-0">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="action-group" wire:click.stop>
                                        <a href="{{ route('tipo_emisor.edit', $item->id) }}"
                                           class="act-btn edit"
                                           data-bs-toggle="tooltip" title="Editar">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>

                                        <form action="{{ route('tipo_emisor.destroy', $item->id) }}" method="post" class="form-eliminar d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center text-muted">No hay tipos de emisor registrados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
